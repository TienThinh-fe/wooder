...
window.addEventListener('scroll', function () {
    ...
    if (positionScroll > positionSectionProduct && positionScroll < positionFooter + 50) {
...
$carousel.flickity({
    ...
    on: {
        ...
        change: function (index) {
            let number = $('.slider__bottom .paging .paging__number #number')
...
var $controlPhoto = $('.photos').flickity();

var $progressBar = $('.timeline');

$controlPhoto.on('scroll.flickity', function (event, progress) {
